...
public class ListTest {
    ...
    public void oldList() {
        ...
        list.stream().filter(obj -> obj instanceof Integer).forEach(System.out::println);
    }
    ...
    /**
     * Если мы создаём список объектов какого-то типа,
     * то добавлять мы в него можем и наследников этого типа
     */
    @Test
    public void testMyClassInherit() {
        List<MyClass> myClassList = new ArrayList<MyClass>();
        myClassList.add(new MyClass(11));
        myClassList.add(new MySubclass(2));
        assertEquals(11, myClassList.get(0).value);
    }
}
